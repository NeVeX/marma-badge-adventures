...
public class Target : MonoBehaviour
{
    ...
    [Header("Audio")]
    public RandomAudioClipPlayer HitAudioPlayer;
    ...
    public void Got(float damage)
    {
        ...
        if (HitAudioPlayer != null)
        {
            ...
            source.pitch = HitAudioPlayer.source.pitch;
            source.PlayOneShot(HitAudioPlayer.GetRandomClip());
        }
